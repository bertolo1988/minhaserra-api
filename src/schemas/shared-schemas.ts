...
export const BirthDateSchema: Schema = {
  ...
  nullable: true,
  format: 'date',
  errorMessage: `must be a valid date in format YYYY-MM-DD`,
};
...
export const PasswordSchema: Schema = {
  ...
  errorMessage: `must be have at least 8 characters and at most 64 characters, and must contain at least one uppercase letter, one lowercase letter, one digit, and one special character`,
};
